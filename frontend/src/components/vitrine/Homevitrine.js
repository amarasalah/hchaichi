  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await axios.post(
        "https://hchaichi-bmqq.vercel.app/form/sendemail",
        data,
    ...
    if (window.jQuery(".owl-single").length > 0) {
      ...
      function changed(event) {
        ...
        if (i == 0 || i == null) {
          ...
          window
            .jQuery('.js-custom-dots a[data-index="' + i + '"]')
            .addClass("active");
        }
      }
  ...
  return (
    <>
      <div
        ...
        data-aos-delay="0"
        className={isActive ? "offcanvas-menu" : ""}
      >
        <div
          ...
          <div className="site-mobile-menu-body" ref={mobileMenuBodyRef}>
            <ul className="site-nav-wrap">
              ...
              <li className="has-children">
                <span
                  className={`arrow-collapse ${isSubActive ? "collapsed" : ""}`}
                  onClick={toggleSubActive}
                ></span>
                  ...
                  <li className="has-children">
                    <span
                      className={`arrow-collapse ${
                        isSubSubActive ? "collapsed" : ""
                      }`}
                      onClick={toggleSubSubActive}
                    ></span>
                    <a href="#">Menu Two</a>
          ...
          <div className="container">
            <div className="site-navigation" ref={cloneNavRef}>
              <a href="/" className="logo m-0 float-left">
                Landing<span className="text-primary">.</span>
              </a>
                  ...
                  <ul className="list-unstyled ul-links mb-4">
                    ...
                    <li>
                      <a
                        ...
                        className="d-flex"
                      >
                        <span className="mt-1 icon-globe mr-2"></span>
