...
const clientId =
  "212614114764-scduo8rud6qlrg210iqpu7b981kl2hvd.apps.googleusercontent.com";
...
const Signup = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const response = await axios.post(
        "https://hchaichi-bmqq.vercel.app/auth/register",
        data,
      ...
      if (response.data.result) {
        ...
        navigate("/auth/verifemail", {
          state: { email: response.data.email, id: response.data.id },
        });
      } else {
        Swal.fire({
          title: "Error",
  ...
  const onSuccess = (res) => {
    ...
    try {
      axios
        .post(
          "https://hchaichi-bmqq.vercel.app/auth/google/register",
          res.profileObj,
          { withCredentials: true }
        )
        .then((response) => {
              ...
              <div className="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px ">
                <div className="d-flex flex-row-fluid flex-column flex-center text-center p-10 pt-lg-20">
                  <a href="/" className="py-9 mb-10">
                    <img
                      alt="Logo"
                      src="/assets/media/logos/logo-compact-light.svg"
                      className="h-70px"
                    />
                  </a>
                  ...
                  <div className="form w-100">
                    ...
                    >
                      <div className="d-flex align-items-center mb-10">
                        ...
                        <span className="fw-semibold text-gray-500 fs-7 mx-2">
                          OR
                        </span>
                        <div className="border-bottom border-gray-300 mw-50 w-100"></div>
                      </div>
