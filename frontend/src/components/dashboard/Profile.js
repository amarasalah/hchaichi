...
function Profile() {
    ...
    const fetchUser = async () => {
      try {
        const response = await axios.get(
          `https://hchaichi-bmqq.vercel.app/api/client/${userId}`,
  ...
  const onSubmitEmail = async (data) => {
    try {
      ...
      const response = await axios.put(
        `https://hchaichi-bmqq.vercel.app/api/user/${userId}/email`,
        { email: data.email },
        { withCredentials: true }
      );
  ...
  const handleDelete = async () => {
    ...
    if (result.isConfirmed) {
      try {
        await axios.delete(
          `https://hchaichi-bmqq.vercel.app/api/deleteaccount/${userId}`,
          { withCredentials: true }
        );
  ...
  const onSubmitPassword = async (data) => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://hchaichi-bmqq.vercel.app/api/user/${userId}/password`,
        {
  ...
  const onSubmitIMG = async (data) => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://hchaichi-bmqq.vercel.app/api/user/img/${userId}`,
        formData,
        {
          headers: {
  ...
  const onSubmitFirstName = (data) => {
    ...
    axios
      .put(`https://hchaichi-bmqq.vercel.app/api/user/${userId}/firstname`, {
      ...
      .catch((error) =>
        Swal.fire("Error", "Error updating first name", "error")
      );
  ...
  const onSubmitLastName = (data) => {
    axios
      .put(`https://hchaichi-bmqq.vercel.app/api/user/${userId}/lastname`, {
      ...
      .catch((error) =>
        Swal.fire("Error", "Error updating last name", "error")
      );
  };
  ...
  const onSubmitAddress1 = async (data) => {
    ...
    try {
      const response = await axios.put(
        `https://hchaichi-bmqq.vercel.app/api/user/${userId}/address1`,
      ...
      Swal.fire(
        "Error",
        error.response?.data?.message ||
          "There was an error updating Address 1.",
        "error"
      );
    }
  ...
  const onSubmitAddress2 = async (data) => {
    ...
    try {
      const response = await axios.put(
        `https://hchaichi-bmqq.vercel.app/api/user/${userId}/address2`,
      ...
      Swal.fire(
        "Error",
        error.response?.data?.message ||
          "There was an error updating Address 2.",
        "error"
      );
    }
  ...
  const onSubmitPhone = async (data) => {
    ...
    try {
      const response = await axios.put(
        `https://hchaichi-bmqq.vercel.app/api/user/${userId}/phone`,
        { phone: data.Phone }
      );
      setUser(response.data.user);
      resetFormPhone();
      ...
      Swal.fire(
        "Error",
        error.response?.data?.message ||
          "There was an error updating the phone.",
        "error"
      );
    }
  ...
  const onSubmitTown = async (data) => {
    ...
    try {
      const response = await axios.put(
        `https://hchaichi-bmqq.vercel.app/api/user/${userId}/town`,
        { town: data.Town }
      );
      setUser(response.data.user);
      resetFormTown();
      ...
      Swal.fire(
        "Error",
        error.response?.data?.message ||
          "There was an error updating the town.",
        "error"
      );
    }
  ...
  const onSubmitState = async (data) => {
    ...
    try {
      const response = await axios.put(
        `https://hchaichi-bmqq.vercel.app/api/user/${userId}/state`,
        { state: data.State }
      );
      setUser(response.data.user);
      resetFormState();
  ...
  const onSubmitPostCode = async (data) => {
    ...
    try {
      const response = await axios.put(
        `https://hchaichi-bmqq.vercel.app/api/user/${userId}/postcode`,
      ...
      Swal.fire(
        "Error",
        error.response?.data?.message ||
          "There was an error updating the post code.",
        "error"
      );
    }
  ...
  const onSubmitCountry = async (data) => {
    ...
    try {
      const response = await axios.put(
        `https://hchaichi-bmqq.vercel.app/api/user/${userId}/country`,
          ...
          <div className="card mb-5 mb-xl-8">
            <div className="card-body">
              <div className="d-flex flex-center flex-column py-5">
                ...
                <a className="fs-3 text-gray-800 text-hover-primary fw-bold mb-3">
                  {user.firstName}{" "}
                  {user.lastName !== "its$fromgoogle" ? user.lastName : ""}
                </a>
              </div>
              ...
              <div id="kt_user_view_details" className="collapse show">
                <div className="pb-5 fs-6">
                  ...
                  <div className="text-gray-600">
                    {user.addr1 ? user.addr1 : "-"}
                  </div>

                  <div className="fw-bold mt-5">Address 2</div>
                  <div className="text-gray-600">
                    {user.addr2 ? user.addr2 : "-"}
                  </div>
                ...
                <div className="card-body">
                  ...
                  >
                    <div className="card-body border-top p-9">
                      ...
                      <div className="form-check form-check-solid fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                        <input
                          name="deactivate"
        ...
        <div className="modal-dialog modal-dialog-centered mw-350px">
          <div className="modal-content">
            <form
              ...
              onSubmit={handleSubmitForm4(onSubmitIMG)}
            >
          ...
          <div className="modal-content">
            ...
            <div className="modal-body scroll-y mx-5 mx-xl-15 my-7">
              <form
                ...
                className="form"
                onSubmit={handleSubmitForm1(onSubmitEmail)}
              >
                ...
                <div className="fv-row mb-7">
                  ...
                  />
                  {errorsForm1.email && (
                    <p className="text-danger">{errorsForm1.email.message}</p>
                  )}
                </div>
                ...
                <div className="mb-10 fv-row" data-kt-password-meter="true">
                  <div className="mb-1">
                        ...
                        {...registerForm2("new_password", {
                          ...
                          pattern: {
                            value:
                              /^(?=.*[A-Za-z])(?=.*\d)(?=.*[@!%*?&])[A-Za-z\d@!%*?&]{8,}$/,
                            message:
                              "Use 8 or more characters with a mix of letters, numbers & symbols except $",
                          },
                        })}
                        autoComplete="off"
                    ...
                    <div className="d-flex align-items-center mb-3">
                      <div
                        className={`flex-grow-1 rounded h-5px me-2 bg-secondary bg-active-success  ${
                          passwordStrength > 0 ? "active" : ""
                        }`}
                      ></div>
                      <div
                        className={`flex-grow-1 rounded h-5px me-2 bg-secondary bg-active-success  ${
                      ...
                      ></div>
                      <div
                        className={`flex-grow-1 rounded h-5px bg-secondary bg-active-success  ${
            ...
            <div className="modal-body">
              <form onSubmit={handleSubmitFirstName(onSubmitFirstName)}>
                <div className="mb-3">
                  ...
                  />
                  {errorsFirstName.firstName && (
                    <p className="text-danger">
                      {errorsFirstName.firstName.message}
                    </p>
                  )}
                </div>
            ...
            <div className="modal-body">
              <form onSubmit={handleSubmitLastName(onSubmitLastName)}>
                <div className="mb-3">
                  ...
                  />
                  {errorsLastName.lastName && (
                    <p className="text-danger">
                      {errorsLastName.lastName.message}
                    </p>
                  )}
                </div>
                <button type="submit" className="btn btn-primary">
              ...
              <form onSubmit={handleSubmitAddress1(onSubmitAddress1)}>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="form-control"
                    id="Address1"
                    {...registerAddress1("address1", {
                      required: "Address1 is required",
                    })}
                  />
                  {errorsAddress1.address1 && (
                    <p className="text-danger">
                      {errorsAddress1.address1.message}
                    </p>
                  )}
                </div>
                <div className="text-center pt-15">
              ...
              <form onSubmit={handleSubmitAddress2(onSubmitAddress2)}>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="form-control"
                    id="Address2"
                    {...registerAddress2("address2", {
                      required: "Address2 is required",
                    })}
                  />
                  {errorsAddress2.address2 && (
                    <p className="text-danger">
                      {errorsAddress2.address2.message}
                    </p>
                  )}
                </div>
                <div className="text-center pt-15">
            ...
            <div className="modal-body">
              <form onSubmit={handleSubmitPhone(onSubmitPhone)}>
                <div className="mb-3">
                  ...
                  />
                  {errorsPhone.Phone && (
                    <p className="text-danger">{errorsPhone.Phone.message}</p>
                  )}
                </div>
                <div className="text-center pt-15">
                  <button type="submit" className="btn btn-primary">
            ...
            <div className="modal-body">
              <form onSubmit={handleSubmitTown(onSubmitTown)}>
                <div className="mb-3">
                  ...
                  />
                  {errorsTown.Town && (
                    <p className="text-danger">{errorsTown.Town.message}</p>
                  )}
                </div>
                <div className="text-center pt-15">
                  <button type="submit" className="btn btn-primary">
            ...
            <div className="modal-body">
              <form onSubmit={handleSubmitState(onSubmitState)}>
                <div className="mb-3">
                  ...
                  />
                  {errorsState.State && (
                    <p className="text-danger">{errorsState.State.message}</p>
                  )}
                </div>
                <div className="text-center pt-15">
                  <button type="submit" className="btn btn-primary">
              ...
              <form onSubmit={handleSubmitPostCode(onSubmitPostCode)}>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="form-control"
                    id="PostCode"
                    {...registerPostCode("PostCode", {
                      required: "Post Code is required",
                    })}
                  />
                  {errorsPostCode.PostCode && (
                    <p className="text-danger">
                      {errorsPostCode.PostCode.message}
                    </p>
                  )}
                </div>
                <div className="text-center pt-15">
