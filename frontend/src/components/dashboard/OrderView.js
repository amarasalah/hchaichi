  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(
        `https://hchaichi-bmqq.vercel.app/product/order/${orderId}`,
        {
      ...
      setprojectNameinvoice(order.projectName);
      setShapeNameinvoice(order.shapeName);
      setOriginalShapeCostinvoice(order.OriginalShapeCost);
      setDiscountedShapeCostinvoice(order.DiscountedShapeCost);
      setDiscountShapeinvoice(order.DiscountShape);
      ...
      setDiscountedMaterialCostinvoice(order.DiscountedMaterialCost);
      setDiscountMaterialinvoice(order.DiscountMaterial);
                  ...
                  <div className="d-flex flex-stack pb-10">
                    <a href="/">
                      <img
                        alt="Logo"
                        src={
                          "https://hchaichi-bmqq.vercel.app/settings/image/" +
                          receiver.logopath
                        }
                      />
                    </a>
                ...
                <div className="m-0">
                  <div className="fw-bold fs-3 text-gray-800 mb-8">
                    ...
                    {(() => {
                      ...
                      switch (status) {
                        case "approved":
                          badgeClass =
                            "badge badge-light-success fw-bold me-2 fs-3";
                          badgeText = "(Approved)";
                          break;
                        case "denied":
                          badgeClass =
                            "badge badge-light-danger fw-bold me-2 fs-3";
                          badgeText = "(Denied)";
                          break;
                        case "pending":
                          badgeClass =
                            "badge badge-light-warning fw-bold me-2 fs-3";
                          badgeText = "(Pending)";
                          break;
                        case "canceled":
                          badgeClass =
                            "badge badge-light-secondary fw-bold me-2 fs-3";
                          badgeText = "(Canceled)";
                          break;
                        default:
                          badgeClass =
                  ...
                  <div className="row g-5 mb-11">
                    ...
                    {receiver.ApprovedDate && (
                      <div className="col-sm-6">
                        ...
                        <div className="fw-bold fs-6 text-gray-800 d-flex align-items-center flex-wrap">
                          <span className="pe-2">
                            {new Date(receiver.ApprovedDate).toLocaleString()}
                          </span>
                        </div>
                      </div>
                    )}
                    {receiver.DeclinedDate && (
                      <div className="col-sm-6">
                        ...
                        <div className="fw-bold fs-6 text-gray-800 d-flex align-items-center flex-wrap">
                          <span className="pe-2">
                            {new Date(receiver.DeclinedDate).toLocaleString()}
                          </span>
                        </div>
                      </div>
                    )}
                  ...
                  <div className="row g-5 mb-12">
                    ...
                    <div className="col-sm-6">
                      ...
                      <div className="fw-bold fs-6 text-gray-800">
                        {orderData.firstName}{" "}
                        {orderData.lastName !== "its$fromgoogle"
                          ? orderData.lastName
                          : ""}
                      </div>

                      <div className="fw-semibold fs-7 text-gray-600">
                        {orderData.addr1 ? orderData.addr1 : ""}
                        <br />
                        {orderData.addr2 ? orderData.addr2 : ""}
                        <br />
                        {orderData.town ? orderData.town : ""},{" "}
                        {orderData.country ? orderData.country : ""},{" "}
                        {orderData.postCode ? orderData.postCode : ""},{" "}
                        {orderData.sp ? orderData.sp : ""}
                      </div>
                    </div>
                  </div>
                        ...
                        <tbody>
                          <tr className="fw-bold text-gray-700 fs-5 border-bottom">
                            ...
                            <td>
                              ...
                              {B_valueinvoice > 0 ? " | " + B_valueinvoice : ""}{" "}
                              {C_valueinvoice > 0 ? " | " + C_valueinvoice : ""}{" "}
                              )
                            </td>
                          ...
                          <tr className="fw-bold text-gray-700 fs-5 border-bottom">
                            ...
                            <td className="fs-5 text-gray-900 fw-bolder text-end">
                              {edgesList.reduce(
                                (total, edge) => total + edge.OriginalEdgeCost,
                                0
                              )}{" "}
                              DT
                            </td>
                          ...
                          <div className="text-end fw-bold fs-6 text-gray-800">
                            ...
                            {quantity *
                              (DiscountShapeDTinvoice +
                                ...
                                edgesList.reduce(
                                  (total, edge) => total + edge.DiscountEdgeDT,
                                  0
                                ))}{" "}
                            DT
                          </div>
                            ...
                            {quantity *
                              (VatShape * 0.01 * OriginalShapeCostinvoice +
                                ...
                                edgesList.reduce(
                                  (total, edge) =>
                                    total +
                                    edge.OriginalEdgeCost * 0.01 * edge.VatEdge,
                                  0
                                ))}{" "}
                            DT
                          </div>
            ...
            <div className="m-0">
              <div className=" border border-dashed border-gray-300 card-rounded h-lg-100 min-w-md-350px p-9 bg-lighten">
                ...
                <div className="mb-6">
                  ...
                  <div className="fw-bold text-gray-800 fs-6">
                    {orderData.userId} <br />({orderData.firstName}{" "}
                    {orderData.lastName !== "its$fromgoogle"
                      ? orderData.lastName
                      : ""}
                    )
                ...
                {(Mdescription.angle || Mdescription.edge) && (
                  <h6 className="mb-8 fw-bolder text-gray-600 text-hover-primary">
                    DESCRIPTION
                  </h6>
                )}
                      ...
                      <table className="table mb-3">
                        <thead>
                          <tr className="border-bottom fs-6 fw-bold text-muted">
                            ...
                            <th className="min-w-100px pb-2 d-print-none">
                              Download
                            </th>
                          </tr>
                        </thead>
                        <tbody>
                          {files.map((file, index) => (
                            <tr
                              className="fw-bold text-gray-700 fs-5 border-bottom"
                              key={index}
                            >
                              <td>{file.originalname}</td>
                              <td className="d-print-none">
                                <a
                                  href={`https://hchaichi-bmqq.vercel.app/product/image/order/${file.path}`}
                                  download={file.path}
                                >
                                  Download
                                </a>
