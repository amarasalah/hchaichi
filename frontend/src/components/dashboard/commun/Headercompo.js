...
function Headercompo({ breadcrumb, lastbreadcrumbItem, onToggleAside }) {
  ...
  const baseURL = "https://hchaichi-bmqq.vercel.app/api/image/profile/";
  const NotificationImage = ({ notification, baseURL }) => {
    const theImage = notification.sender.image
  ...
  const fetchClientsData = async () => {
    ...
    try {
      const response = await axios.get(
        "https://hchaichi-bmqq.vercel.app/api/getclients",
        {
          params: {
            limit: userLimit,
            search: searchInput,
  ...
  const handleSendMessageUser = async (userId) => {
    ...
    if (formValues) {
      try {
        await axios.post(
          "https://hchaichi-bmqq.vercel.app/chat/user/post",
          {
            receiver: userId,
            content: formValues,
          },
  ...
  const fetchNotifications = async () => {
    try {
      const response = await axios.get(
        "https://hchaichi-bmqq.vercel.app/notifications/get",
        {
          params: {
            userId: userID,
            limit: currentLimit,
  ...
  const markNotificationsAsRead = async (notificationIds) => {
    try {
      await axios.post("https://hchaichi-bmqq.vercel.app/notifications/read", {
        notificationIds,
      });
      fetchNotifications();
    } catch (error) {
      ...
      >
        ...
        <div className="d-flex align-items-center flex-shrink-0">
                          ...
                          >
                            ...
                            <div className="d-flex flex-column">
                              <span className="fs-6 text-gray-800 fw-semibold">
                                {client.firstName}{" "}
                                {client.lastName !== "its$fromgoogle"
                                  ? client.lastName
                                  : ""}{" "}
                                <button
                                  className="btn btn-icon me-2"
                                  onClick={() =>
                                    handleSendMessageUser(client._id)
                                  }
                                >
                                  {" "}
                                  <i className="ki-duotone ki-messages fs-1 ">
                                    {" "}
          ...
          {(userRole == "admin" || userRole == "assistance") && (
            ...
            >
              <div
                className={`btn btn-icon btn-active-light-primary position-relative w-35px h-35px w-md-40px h-md-40px ${
                  notificationMenuVisible ? "show" : ""
                }`}
              ...
              <div
                className={`menu menu-sub menu-sub-dropdown menu-column w-350px ${
                  notificationMenuVisible ? "show" : ""
                }`}
                style={{
                  zIndex: 107,
                        ...
                        (notification) =>
                          (notification.type === "order" &&
                            userRole == "admin" && (
                              <div
                                ...
                                className={`d-flex align-items-center bg-hover-lighten py-3 px-9 pointer`}
                                onClick={() =>
                          ...
                          (notification.type === "message" && (
                            ...
                            >
                              ...
                              <div className="mb-1 pe-3 flex-grow-1">
                                <a className="fs-6 text-gray-900 fw-semibold">
                                  {notification.content}
                                </a>
                                <p className="fs-7 ">
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                inset: "0px 0px auto auto",
                margin: 0,
                transform: "translate3d(-35.4px, 69.8px, 0px)",
              }}
            >
                ...
                <div className="menu-content d-flex align-items-center px-3">
                  ...
                  <div className="d-flex flex-column">
                    <div className="fw-bold d-flex align-items-center fs-5">
                      {userFirstName}{" "}
                      {userLastName !== "its$fromgoogle" ? userLastName : ""}
                    </div>
              ...
              <div className="menu-item px-5 my-1">
                <a href={"/user/profile/" + userID} className="menu-link px-5">
                  Account Settings
                </a>
              </div>
