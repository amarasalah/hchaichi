    ...
    const fetchEdge = async () => {
      try {
        const response = await axios.get(
          `https://hchaichi-bmqq.vercel.app/product/edge/${EdgeId}`,
        ...
        if (response.data.edge.avatarEdge) {
          setImagePreviews({
            avatarEdge:
              "https://hchaichi-bmqq.vercel.app/product/image/edge/" +
              response.data.edge.avatarEdge,
          });
        } else {
          setImagePreviews({
          ...
          <div className="card card-flush py-4">
            ...
            <div className="card-body pt-0">
              ...
              >
                ...
                <option
                  value="not_available"
                  selected={formData.status === "not_available"}
                >
                  Not Available
                </option>
              </select>
                    ...
                    <div className="mb-2 fv-row">
                      ...
                      <div className="mb-2">
                        <textarea
                          ...
                          defaultValue={formData.edgedescription}
