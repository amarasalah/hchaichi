...
function AddEdge() {
  ...
  const handleSubmit = async (e) => {
    ...
    const requiredFields = ["avatarEdge", "edge_name", "price"];
    ...
    try {
      const response = await axios.post(
        "https://hchaichi-bmqq.vercel.app/product/addedge",
        data,
        {
          headers: {
      ...
      Swal.fire({
        icon: "success",
        title: "Edge Added Successfully",
        text: response.data.message || response.data,
      });
      // navigate("/admin/alledgetype", { replace: true });
    } catch (error) {
      console.error("There was an error!", error);
      Swal.fire({
        icon: "error",
        title: "Error",
        text: "There was an error adding the edge!",
      });
    }
    btnRef2.current.style.display = "none";
    btnRef1.current.style.display = "block";
          ...
          <div className="card card-flush py-4">
            ...
            <div className="card-body text-center pt-0">
              ...
              <div className="text-muted fs-7">
                Set the edge thumbnail image. Only *.png, *.jpg, *.svg and
                  ...
                  <div className="card-body pt-0">
                    <div className="mb-2 fv-row">
                      ...
                      <input
                        ...
                        defaultValue={formData.edge_name}
                        onChange={handleInputChange}
                      />

                      <div className="text-muted fs-7">
                        A edge name is required and recommended to be unique.
                      </div>
                    </div>
